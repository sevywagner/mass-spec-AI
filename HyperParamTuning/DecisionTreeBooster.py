import numpy as np
from metricsHelpers import binaryCrossentropy
# from concurrent.futures import ThreadPoolExecutor

class DecisionTreeBooster:
    def __init__(self, X, gradients, hessians, learning_rate=.1, n_learners=200, subsample=.25, max_depth=5, min_samples=2, gamma=0.0, reg_lambda=1.0):
